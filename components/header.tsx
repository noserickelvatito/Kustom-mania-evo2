  ...
  return (
    <header className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 sm:px-6 md:px-8 py-4 sm:py-6 gap-4 sm:gap-0 bg-black/80 backdrop-blur-sm">
      ...
      <a
        ...
        className="inline-flex items-center gap-2 px-4 py-2 text-xs sm:text-sm tracking-widest text-white bg-gradient-to-r from-[#25D366] to-[#20BA5A] hover:from-[#20BA5A] hover:to-[#25D366] transition-all duration-300 uppercase font-medium rounded-lg hover:scale-105 shadow-lg hover:shadow-[#25D366]/50"
      >
