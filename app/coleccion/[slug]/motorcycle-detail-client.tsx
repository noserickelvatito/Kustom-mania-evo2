...
import { useProductView, useScrollTracking } from "@/hooks/use-analytics"
import type { Motorcycle, MotorcycleImage } from "@/lib/types"
import type { GAProductParams } from "@/lib/analytics"
...
export function MotorcycleDetailClient({ motorcycle, images, whatsappNumber }: MotorcycleDetailClientProps) {
  // Track product view
  const productData: GAProductParams = {
    product_id: motorcycle.id,
    product_name: motorcycle.name,
    marca: motorcycle.brand,
    tipo_de_moto: motorcycle.motorcycle_type,
  ...
  useScrollTracking(`/coleccion/${motorcycle.slug}`)
          ...
          <div className="relative z-10 max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <ImageGallery
                ...
                type={motorcycle.motorcycle_type}
              />
              ...
              <div>
                ...
                <WhatsAppButton
                  ...
                  motorcycleType={motorcycle.motorcycle_type}
